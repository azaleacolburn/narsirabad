build:
    cc test/main.c alloc.c gc.c mem.c blocklist.c -o target/main -Wall -Werror -Wpedantic
    cc test/fuzzy.c alloc.c gc.c mem.c blocklist.c -o target/fuzzy -Wall -Werror -Wpedantic
